...
import online.nexalink.app.fmt.CustomFmt
import online.nexalink.app.fmt.Hysteria2Fmt
import online.nexalink.app.fmt.ShadowsocksFmt
import online.nexalink.app.fmt.SocksFmt
import online.nexalink.app.fmt.TrojanFmt
import online.nexalink.app.fmt.V2rayNFmt
import online.nexalink.app.fmt.VlessFmt
import online.nexalink.app.fmt.VmessFmt
import online.nexalink.app.fmt.WireguardFmt
import online.nexalink.app.util.DeviceUtil
            ...
            var configText = try {
                ...
                HttpUtil.getUrlContentWithUserAgent(
                    UrlContentRequest(
                        ...
                        forcedHeaders = DeviceUtil.hwidHeaders(),
                        timeout = 15000,
                        httpPort = httpPort,
